...
export default function ExamTEstTable () {
                    ...
                    <div className={mainExamTableCss.ExamsTestTable}>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                <Link href={'/exam-test/exam-typing'} className={mainExamTableCss.startbtn}><i className="fa-solid fa-play"></i> Start Test</Link>
                                </td>
                            </tr>
                            <tr>
