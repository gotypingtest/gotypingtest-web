              ...
              <div className="container">
                <div className="row">
                  ...
                  <ul>
                    ...
                    <div className={mainTypingCss.homeLearnTypingallButtonCss}>
              ...
              <div className="container">
                <div className="row">
                  ...
                  {/* <div className={mainTypingCss.examsTypestStoriesCss}>
                      ...
                      >
                          <SwiperSlide>
                              <div className={mainTypingCss.PartnerTestimonials}>
                                  <div className={mainTypingCss.PartnerDataName}>
                                      <small>
                                  ...
                                  <div className={mainTypingCss.PartnerDescription}>
