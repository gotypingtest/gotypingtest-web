...
export default function Exams () {
  ...
  return (
        <section className={mainExamsCss.examsPageCss}>
            <div className={mainExamsCss.examsTopCss}>
                <div className='container'>
                    ...
                    <div className={mainExamsCss.examsTopButtonCss}>
                    <Link  href={'/'}>Start Practicing Now</Link>
                    </div>
                    </div>
                </div>
            </div>
            <div className={mainExamsCss.examsTypingCss}>
              <div className="container">
                <div className="row">
                  <div className={mainExamsCss.examsTypingHeadCss}>
                  ...
                  <ul>
                    ...
                    <div className={mainExamsCss.homeLearnTypingallButtonCss}><span onClick={toggleFaqVisibility}>View {isReadMoreFaq ? 'Less' : 'All Exams'} </span></div>
                  </ul>
                </div>  
              </div>
            </div>
            {/* <div className={mainExamsCss.examsTypestCss}>
              <div className="container">
                <div className="row">
                  <div className="col-md-12">
                  <div className={mainExamsCss.examsTypestHeadCss}>
                    <small>Stories</small>
                    <h2>Success <span>Stories</span></h2>
                    <p>Prepare for SSC, RRB, DSSSB, Delhi Police and other competitive exams with real exam-style typing tests</p>
                  </div>
                  <div className={mainExamsCss.examsTypestStoriesCss}>
                      <Swiper
                      ...
                      >
                          <SwiperSlide>
                              <div className={mainExamsCss.typestReviewBox}>
                                  <div className={mainExamsCss.typestNameData}>
                                      <small>
                                  ...
                                  <div className={mainExamsCss.reviewDescription}>
                                      ...
                                      <div className={mainExamsCss.PartnersVideoPart}>
                                          <b>
            ...
            <div className={mainExamsCss.dataHistoryCss}>
          <div className="container">
            <div className="row">
              <ul>
                <li>
