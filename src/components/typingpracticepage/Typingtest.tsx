...
export default function Typingtest () {
  ...
  return (
        <section className={mainExamsCss.examsTypingCss}>
                ...
                <div className='col-md-8 mx-auto p-5'>
                  ...
                  <div className={mainExamsCss.examsTypingControllBar}>
                    ...
                    <div className={mainExamsCss.examsTypingBarButton}>
                        ...
                        {/* <Link href={'/exam-test/typing-result'} className={mainExamsCss.examsTypingLink}><i className="fa-solid fa-play"></i> Start Test</Link> */}
                    </div>
                  </div>
                </div>
              </div>
